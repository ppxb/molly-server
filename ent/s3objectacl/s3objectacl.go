...
const (
	// Label holds the string label denoting the s3objectacl type in the database.
	Label = "s3object_acl"
	...
	// Table holds the table name of the s3objectacl in the database.
	Table = "s3_object_acl"
)

// Columns holds all SQL columns for s3objectacl fields.
var Columns = []string{
	FieldID,
	FieldBucketName,
	FieldObjectKey,
...
// OrderOption defines the ordering options for the S3ObjectACL queries.
