...
func (_q *S3BucketQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *S3BucketQuery) FirstIDX(ctx context.Context) int {
...
func (_q *S3BucketQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *S3BucketQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *S3BucketQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *S3BucketQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(s3bucket.FieldBucketName).
//		Aggregate(gen.Count()).
//		Scan(ctx, &v)
...
//
//	client.S3Bucket.Query().
//		Select(s3bucket.FieldBucketName).
//		Scan(ctx, &v)
...
func (_q *S3BucketQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(s3bucket.Table, s3bucket.Columns, sqlgraph.NewFieldSpec(s3bucket.FieldID, field.TypeInt))
	_spec.From = _q.sql
