...
func (_q *SysConfigQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SysConfigQuery) FirstIDX(ctx context.Context) int {
...
func (_q *SysConfigQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SysConfigQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *SysConfigQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *SysConfigQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SysConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(sysconfig.Table, sysconfig.Columns, sqlgraph.NewFieldSpec(sysconfig.FieldID, field.TypeInt))
	_spec.From = _q.sql
